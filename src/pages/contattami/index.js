        ...
        <>
            ...
            <div className="flex flex-col max-w-2xl mx-auto mt-12">
                <div className="mb-8">
                    ...
                    <p className="font-light text-gray-500 md:text-lg lg:text-xl dark:text-gray-400 mb-4">Se hai un dubbio, cerco di aiutarti. Ti basta riempiere il form 👇</p>
                    <p className="font-light text-gray-500 md:text-lg lg:text-xl dark:text-gray-400 mb-8">Se non rispondo subito e hai fretta, ti conviene seguirmi e scrivermi su <a href="https://instagram.com/iamlucafpv/" target="_blank">Instagram</a></p>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Messaggio</label>
