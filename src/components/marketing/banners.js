            ...
            <span class="ml-3 font-medium py-2">
              <span class="md:hidden">
                ...
                <span class="font-bold">
                  Supportami anche solo con una birra.
                </span>
              </span>
              <span class="hidden md:inline">
                Se questo articolo ti è stato utile,{" "}
                <span class="font-bold">
                  puoi supportami anche solo con una birra al mese.
                </span>
              </span>
            </span>
          </div>
...
const Support = ({ customLabel, customText }) => {
  return (
      ...
      <div class="mx-auto max-w-7xl p-2 md:p-3">
        <div class="flex flex-col md:flex-row justify-between">
          <div class="flex flex-row md:w-4/6">
            ...
            <span class="ml-3 font-medium py-2">
              <span class="md:hidden ">
                {customLabel ? customLabel : "Stai trovando utile l'articolo?"}
                <span class="font-bold">
                  {customLabel ? customLabel : "Considera di supportarmi!"}
                </span>
              </span>
              {customText ? (
                <span class="hidden md:inline">{customText}</span>
              ) : (
                <span class="hidden md:inline">
                  Stai trovando utile l'articolo?{" "}
                  <span class="font-bold">
                    Puoi supportami anche solo con una birra al mese.
                  </span>
                </span>
